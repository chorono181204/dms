...
import scopeDepartment from '../../middlewares/scope';
...
router
  ...
  .get(auth('getUsers'), scopeDepartment('query'), validate(userValidation.getUsers), userController.getUsers);
...
router.post('/:userId/signature', auth('manageUsers'), upload.single('file'), userController.uploadSignature);
